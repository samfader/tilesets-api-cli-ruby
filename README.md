...
\* By properly scoped access token, I mean **tilesets:read**, **tilesets:list**, and **tilesets:write**. Refer to the [Mapbox docs](https://docs.mapbox.com/help/tutorials/get-started-tilesets-api-and-cli/) for more details.
